...
const Section = () => {
  ...
  return (
    <div className='md:items-center flex flex-col '>
      <div
        className='font-medium 2xl:w-1/3 md:w-2/3 xl:w-1/2 lg:px-0 px-8 text-4xl xl:text-6xl    
          flex flex-col items-center space-x-2 justify-center xl:font-medium xl:pt-14
          text-center pt-6'
      >
