...
const HeroSection = () => {
  ...
  return (
    <div className='md:items-center flex flex-col '>
      <div
        className='font-medium 2xl:w-1/3 md:w-2/3 xl:w-1/2 lg:px-0 px-8 text-5xl
            xl:text-6xl flex justify-center xl:font-medium xl:pt-14 text-center pt-6'
      >
      ...
      {isSmallScreen ? (
        <div
          className='grid md:grid-cols-1 sm:grid-cols-2 place-content-center place-items-center
                     mx-auto space-x-0  xl:space-x-4 items-center justify-between hover:cursor-pointer
                     gap-4 xl:w-3/4 2xl:w-[55%]'
        >
          {tabs.map(tab => (
            <motion.div
              key={tab.name}
        ...
        <div
          className='flex xl:space-x-4 items-center justify-between hover:cursor-pointer
                        gap-4 w-4/5 xl:w-3/4 2xl:w-[55%]'
        >
          {tabs.map(tab => (
            <motion.div
              key={tab.name}
